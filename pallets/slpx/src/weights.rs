...
impl WeightInfo for () {
	...
	fn add_whitelist() -> Weight {
		...
		Weight::from_parts(7_492_000, 3803)
	...
	fn remove_whitelist() -> Weight {
		...
		Weight::from_parts(8_891_000, 3803)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn mint() -> Weight {
		...
		Weight::from_parts(10_826_000, 114987)
	...
	fn mint_with_channel_id() -> Weight {
		...
		Weight::from_parts(11_185_000, 114987)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	/// Storage: `Slpx::WhitelistAccountId` (r:1 w:0)
	...
	fn redeem() -> Weight {
		...
		Weight::from_parts(10_914_000, 114987)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
}
