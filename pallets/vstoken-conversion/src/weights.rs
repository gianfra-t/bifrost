...
impl WeightInfo for () {
	...
	fn set_exchange_fee() -> Weight {
		...
		Weight::from_parts(5_312_000, 1517)
	...
	fn set_exchange_rate() -> Weight {
		...
		Weight::from_parts(5_864_000, 3479)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn set_relaychain_lease() -> Weight {
		...
		Weight::from_parts(5_079_000, 1489)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
	...
	fn vsbond_convert_to_vstoken() -> Weight {
		...
		Weight::from_parts(67_246_000, 11362)
	...
	fn vstoken_convert_to_vsbond() -> Weight {
		...
		//  Measured:  `1453`
		//  Estimated: `11362`
		// Minimum execution time: 63_642_000 picoseconds.
		Weight::from_parts(65_012_000, 11362)
