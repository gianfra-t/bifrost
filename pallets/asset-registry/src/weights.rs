...
impl WeightInfo for () {
	...
	fn register_token_metadata() -> Weight {
		...
		Weight::from_parts(9_256_000, 3802)
	...
	fn register_vtoken_metadata() -> Weight {
		...
		Weight::from_parts(12_336_000, 6364)
			.saturating_add(RocksDbWeight::get().reads(2_u64))
	...
	fn register_location() -> Weight {
		...
		//  Measured:  `414`
		//  Estimated: `3879`
		// Minimum execution time: 13_209_000 picoseconds.
		Weight::from_parts(13_801_000, 3879)
	...
	fn force_set_location() -> Weight {
		...
		Weight::from_parts(12_555_000, 3879)
	...
	fn update_currency_metadata() -> Weight {
		...
		Weight::from_parts(10_211_000, 3874)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
}
