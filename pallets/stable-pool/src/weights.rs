...
impl WeightInfo for () {
	...
	fn create_pool() -> Weight {
		...
		Weight::from_parts(18_097_000, 3878)
	...
	fn edit_token_rate() -> Weight {
		...
		Weight::from_parts(16_843_000, 8673)
			.saturating_add(RocksDbWeight::get().reads(4_u64))
	...
	fn add_liquidity() -> Weight {
		...
		//  Measured:  `1488`
		//  Estimated: `8769`
		// Minimum execution time: 115_022_000 picoseconds.
		Weight::from_parts(116_881_000, 8769)
	...
	fn swap() -> Weight {
		...
		Weight::from_parts(108_438_000, 6196)
	...
	fn redeem_proportion() -> Weight {
		...
		Weight::from_parts(111_941_000, 6196)
	...
	fn redeem_single() -> Weight {
		...
		Weight::from_parts(85_507_000, 6196)
			.saturating_add(RocksDbWeight::get().reads(7_u64))
			.saturating_add(RocksDbWeight::get().writes(5_u64))
	}
	/// Storage: `StableAsset::Pools` (r:1 w:1)
	...
	fn redeem_multi() -> Weight {
		...
		Weight::from_parts(103_673_000, 6196)
			.saturating_add(RocksDbWeight::get().reads(7_u64))
			.saturating_add(RocksDbWeight::get().writes(5_u64))
	}
	/// Storage: `StableAsset::Pools` (r:1 w:1)
	...
	fn modify_a() -> Weight {
		...
		Weight::from_parts(9_514_000, 3911)
	...
	fn modify_recipients() -> Weight {
		...
		Weight::from_parts(9_181_000, 3911)
			.saturating_add(RocksDbWeight::get().reads(1_u64))
			.saturating_add(RocksDbWeight::get().writes(1_u64))
	}
}
