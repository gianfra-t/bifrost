...
impl<T: frame_system::Config> bifrost_vstoken_conversion::WeightInfo for BifrostWeight<T> {
	...
	fn set_exchange_fee() -> Weight {
		...
		//  Measured:  `213`
		//  Estimated: `1517`
		// Minimum execution time: 5_593 nanoseconds.
		Weight::from_parts(5_860_000, 1517)
	...
	fn set_exchange_rate() -> Weight {
		...
		Weight::from_parts(6_360_000, 3479)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn set_relaychain_lease() -> Weight {
		...
		//  Measured:  `213`
		//  Estimated: `1489`
		// Minimum execution time: 5_373 nanoseconds.
		Weight::from_parts(5_547_000, 1489)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn vsbond_convert_to_vstoken() -> Weight {
		...
		Weight::from_parts(70_511_000, 11362)
	...
	fn vstoken_convert_to_vsbond() -> Weight {
		...
		//  Measured:  `1453`
		//  Estimated: `11362`
		// Minimum execution time: 64_628 nanoseconds.
		Weight::from_parts(65_908_000, 11362)
