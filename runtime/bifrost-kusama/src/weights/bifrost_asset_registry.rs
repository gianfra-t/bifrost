...
impl<T: frame_system::Config> bifrost_asset_registry::WeightInfo for BifrostWeight<T> {
	...
	fn register_token_metadata() -> Weight {
		...
		//  Measured:  `337`
		//  Estimated: `3802`
		// Minimum execution time: 8_823 nanoseconds.
		Weight::from_parts(9_169_000, 3802)
	...
	fn register_vtoken_metadata() -> Weight {
		...
		//  Measured:  `424`
		//  Estimated: `6364`
		// Minimum execution time: 10_833 nanoseconds.
		Weight::from_parts(11_449_000, 6364)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn register_location() -> Weight {
		...
		Weight::from_parts(12_396_000, 3879)
	...
	fn force_set_location() -> Weight {
		...
		//  Measured:  `414`
		//  Estimated: `3879`
		// Minimum execution time: 10_665 nanoseconds.
		Weight::from_parts(11_213_000, 3879)
	...
	fn update_currency_metadata() -> Weight {
		...
		//  Measured:  `409`
		//  Estimated: `3874`
		// Minimum execution time: 8_681 nanoseconds.
		Weight::from_parts(9_097_000, 3874)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
