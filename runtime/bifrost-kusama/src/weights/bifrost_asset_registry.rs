...
impl<T: frame_system::Config> bifrost_asset_registry::WeightInfo for BifrostWeight<T> {
	...
	fn register_token_metadata() -> Weight {
		...
		//  Measured:  `337`
		//  Estimated: `3802`
		// Minimum execution time: 8_724 nanoseconds.
		Weight::from_parts(9_186_000, 3802)
	...
	fn register_vtoken_metadata() -> Weight {
		...
		//  Measured:  `424`
		//  Estimated: `6364`
		// Minimum execution time: 11_379 nanoseconds.
		Weight::from_parts(11_946_000, 6364)
			.saturating_add(T::DbWeight::get().reads(2))
	...
	fn register_location() -> Weight {
		...
		//  Measured:  `414`
		//  Estimated: `3879`
		// Minimum execution time: 12_203 nanoseconds.
		Weight::from_parts(13_205_000, 3879)
	...
	fn force_set_location() -> Weight {
		...
		Weight::from_parts(11_703_000, 3879)
	...
	fn update_currency_metadata() -> Weight {
		...
		Weight::from_parts(9_833_000, 3874)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
