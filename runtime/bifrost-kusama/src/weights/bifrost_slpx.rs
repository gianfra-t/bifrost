...
impl<T: frame_system::Config> bifrost_slpx::WeightInfo for BifrostWeight<T> {
	...
	fn add_whitelist() -> Weight {
		...
		Weight::from_parts(6_804_000, 3803)
	...
	fn remove_whitelist() -> Weight {
		...
		Weight::from_parts(8_056_000, 3803)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn set_transfer_to_fee() -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 3_993 nanoseconds.
	...
	fn mint() -> Weight {
		...
		Weight::from_parts(10_418_000, 114987)
	...
	fn mint_with_channel_id() -> Weight {
		...
		Weight::from_parts(10_124_000, 114987)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: `Slpx::WhitelistAccountId` (r:1 w:0)
	...
	fn redeem() -> Weight {
		...
		//  Measured:  `81`
		//  Estimated: `114987`
		// Minimum execution time: 9_679 nanoseconds.
		Weight::from_parts(10_250_000, 114987)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
